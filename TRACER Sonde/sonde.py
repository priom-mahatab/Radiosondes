...
output_folder = '/Users/zmahatab/Desktop/MetPy/TRACER Sonde/Plots/'
...
def skewT_generator_11_and_others(folder_path, output_folder):
    ...
    for file in txt_files:
        ...
        if launch_time_utc[:2] == "10" or launch_time_utc[:2] == "11":
            ...
            interval = np.logspace(2, 3) * units.hPa
            idx = mpcalc.resample_nn_1d(p, interval)
            skew.plot_barbs(p[idx][::2], u[idx][::2], v[idx][::2], color="red")
...
skewT_generator_11_and_others(folder_path, output_folder)   
