...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 13 02:34:50 2025
...
input_folder = '/Users/zmahatab/Desktop/MetPy/TRACER Sonde/Plots'
input_folder_2 = '/Users/zmahatab/Desktop/MetPy/TRACER Sonde/Plots/Combined'
output_folder = '/Users/zmahatab/Desktop/MetPy/TRACER Sonde/Plots/Three-Grid'

def resize_to_same_height(img1, img2, img3):
    ...
    return resize(img1), resize(img2), resize(img3)
    ...
    for file1 in os.listdir(input_folder):
        if file1.endswith(".png"):
            ...
            if len(parts1) == 5:
                ...
                if hour_part1 == "10" or hour_part1 == "11":
                    ...
                    for file2 in os.listdir(input_folder):
                        if file2.endswith(".png"):
                            ...
                            if date_part1 == date_part2 and file2 != file1:
                    ...
                    for file3 in os.listdir(input_folder_2):
                        if file3.endswith(".png"):
                            ...
                            if date_part1 == date_part3:
                                ...
                                trimmed_image1, trimmed_image2, trimmed_image3 = resize_to_same_height(
                                                trimmed_image1, trimmed_image2, trimmed_image3
                                            )
                                
            
                                height = max(trimmed_image1.height, trimmed_image2.height, trimmed_image3.height)
                                ...
                                output_filename = os.path.join(output_folder, f"TRACERSonde.{formatted_date}.three-grid.png")
